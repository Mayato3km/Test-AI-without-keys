...
## 🤖 Обзор проекта
### Discord AI Bot - полностью автономный искусственный интеллект для Discord, работающий без внешних API ключей. Бот использует локальную систему правил, память и контекст для интеллектуального общения с пользователями.
